...
class TradeMarket extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div className="c-trade-market">
        <Chart
          ...
          height="450"
        />
        <div className="c-trade-market__bottom">
          <div className="c-trade-market__bottom--seller">
            <div className="c-trade-market__bottom--seller__sell">
              <h2>구매</h2>
              <form onSubmit={this.onSubmitBuy}>
                <TextField
                  id="outlined-password-input"
                  label="구매수량 ( 정수 )"
                  name="buyKw"
                  type="text"
                  value={this.state.buyKw}
                  onChange={this.onChangeBuy}
                  autoComplete="current-password"
                  margin="normal"
                  variant="outlined"
                  helperText="구매하실 전력을 입력해주세요"
                  style={{ width: "90%" }}
                />
                <TextField
                  disabled
            ...
            <div className="c-trade-market__bottom--seller__buy">
              <h2>판매</h2>
              <form onSubmit={this.onSubmitSale}>
                <TextField
                  id="outlined-password-input"
                  label="판매수량 ( 정수 )"
                  name="sellKw"
